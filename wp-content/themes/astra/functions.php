...
// ----------------------------My Custom Elements---------------------------------
wp_enqueue_style('theme-style-oleraj', get_template_directory_uri() . '/assets/css/minified/oleraj.css');
include 'template-parts/table.php';
...
function myscripts()
{
    wp_enqueue_script(
        'javascript',
        get_stylesheet_directory_uri() . '/assets/js/unminified/oleraj.js',
        array('jquery')
    );
}
